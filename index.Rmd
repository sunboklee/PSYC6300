...
* You can download and install **a base distribution and packages (base R)** from the official R webiste: The R Project for Statistical Computing ([https://www.r-project.org](https://www.r-project.org))
